...
export default function CaptionGenerator() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `caption_${result.id}.pdf`;
      a.click();
        ...
        <form onSubmit={handleGenerate} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="z.B. Fitness Transformation, Healthy Recipes, Travel Vlog"
              value={prompt}
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              placeholder="z.B. Zielgruppe: Junge Erwachsene, Tonalität: motivierend"
              value={context}
          ...
          >
            {loading ? 'Wird generiert...' : 'Caption generieren'}
          </button>
        </form>
      </div>
      ...
      {result && (
        <div className="bg-white shadow sm:rounded-lg p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium text-gray-900">Generierte Caption</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-4">
            <p className="text-xs font-medium text-gray-500 mb-2">CAPTION:</p>
