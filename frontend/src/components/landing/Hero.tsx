          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                <span className="block">AI Reels Generator</span>
                <span className="block text-blue-200 mt-2">
                  7 Tools. Endlos Content.
                </span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base text-blue-100 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Erstelle virale Instagram Reels, TikToks und YouTube Shorts mit KI.
                Von Hooks über Scripts bis zum 30-Tage Content-Plan – alles in einer Plattform.
              </p>
              ...
              <div className="mt-8 flex justify-center items-center space-x-6 text-blue-100 text-sm">
